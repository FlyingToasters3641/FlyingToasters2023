...
public class SnapToScoreCommand extends DriveToPose {
    ...
    Pose2d[] Positions = new Pose2d[]{  // .5588
           new Pose2d(xScoringPosition, Units.inchesToMeters(20.19 + (22.0 * 0) - 2), new Rotation2d().fromDegrees(0)),  // .512826
           new Pose2d(xScoringPosition, Units.inchesToMeters(20.19 + (22.0 * 1) - 2), new Rotation2d().fromDegrees(0)),  // .512826 + .5588 = 1.071626
           new Pose2d(xScoringPosition, Units.inchesToMeters(20.19 + (22.0 * 2) + 2), new Rotation2d().fromDegrees(0)),  // 1.630426
           ...
           new Pose2d(xScoringPosition, Units.inchesToMeters(20.19 + (22.0 * 8)), new Rotation2d().fromDegrees(0))  // 4.983226
    };
