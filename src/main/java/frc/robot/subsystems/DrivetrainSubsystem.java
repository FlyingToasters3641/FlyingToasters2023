...
import frc.robot.swerve.Mk4iSwerveModuleHelper;
...
public class DrivetrainSubsystem extends SubsystemBase {
        ...
        // NOTE: Pigeon should be configured so that rotating the robot
        ...
        public void zeroGyroscope() {
                // TODO: Should we be setting the Yaw to zero for Pigeon 2?
                m_pigeon.setYaw(0.0);
        }

        private double getHeading(boolean getFusedHeading) {
                if (getFusedHeading) {
                        return Math.IEEEremainder(m_pigeon.getYaw(), 360.0);
                } else {
                        ...
                        // checkCtreError(m_pigeon.getAccumGyro(xyz), "Failed to get Pigeon accumulated
                        // heading.");
        ...
        SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(Constants.kDriveKinematics,
                        new Rotation2d(m_pigeon.getYaw() * (Math.PI / 180)),
        ...
        public void resetOdometry(Pose2d pose) {
                m_odometry.resetPosition(new Rotation2d(m_pigeon.getYaw() * (Math.PI / 180)),
