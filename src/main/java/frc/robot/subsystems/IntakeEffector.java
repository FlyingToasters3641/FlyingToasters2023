...
public class IntakeEffector extends SubsystemBase {
  ...
  public void periodic() {
      ...
      SmartDashboard.putNumber("Roller output current", m_rollers.getOutputCurrent());
      SmartDashboard.putNumber("Roller encoder", m_rollers.getEncoder().getPosition() - prevEncoder);
      SmartDashboard.putNumber("Roller current / encoder", m_rollers.getOutputCurrent() / (m_rollers.getEncoder().getPosition() - prevEncoder));
      prevEncoder = m_rollers.getEncoder().getPosition();
  }
}
