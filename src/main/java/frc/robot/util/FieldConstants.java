...
public static final class LoadingZone {
    ...
    public static final double innerX = FIELD_LENGTH_METERS;
    ...
    public static final double doubleSubstationCenterY = FIELD_WIDTH_METERS - Units.inchesToMeters(49.76);
    ...
    public static final double singleSubstationLeftX =
        FieldConstants.FIELD_LENGTH_METERS - doubleSubstationLength - Units.inchesToMeters(88.77);
