...
public class ToastedPPSwerveControllerCommand extends CommandBase {
   ...
   */
  public ToastedPPSwerveControllerCommand(
  ...
  public static void setLoggingCallbacks(
    ...
    ToastedPPSwerveControllerCommand.logActiveTrajectory = logActiveTrajectory;
    ToastedPPSwerveControllerCommand.logTargetPose = logTargetPose;
    ToastedPPSwerveControllerCommand.logSetpoint = logSetpoint;
    ToastedPPSwerveControllerCommand.logError = logError;
  }
}
